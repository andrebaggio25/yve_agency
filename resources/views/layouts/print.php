...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 36px; padding-bottom: 24px; border-bottom: 2px solid #6d28d9; }
    .logo { font-size: 22px; font-weight: 800; color: #6d28d9; letter-spacing: -0.5px; }
    ...
    .party-label { font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: #6d28d9; margin-bottom: 6px; }
    ...
    thead th { background: #f5f3ff; color: #5b21b6; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; padding: 8px 12px; text-align: left; }
    ...
    .totals-row.total-final { font-size: 15px; font-weight: 700; color: #1a1a2e; border-top: 2px solid #6d28d9; padding-top: 8px; margin-top: 4px; }
    ...
    .print-btn { position: fixed; bottom: 24px; right: 24px; background: #6d28d9; color: #fff; border: none; border-radius: 10px; padding: 12px 24px; font-size: 14px; font-weight: 600; cursor: pointer; box-shadow: 0 4px 20px rgba(109,40,217,.35); display: flex; align-items: center; gap: 8px; }
