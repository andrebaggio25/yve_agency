  ...
  <form method="POST" action="/faturas" x-data="invoiceForm()" class="space-y-6">
      ...
      <div class="grid sm:grid-cols-2 gap-6">
        ...
        <div class="sm:col-span-2">
          ...
          <textarea name="notes" rows="2"
            class="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-white focus:border-violet-500 focus:outline-none transition-colors resize-none"><?= e($old['notes'] ?? '') ?></textarea>
        </div>
      </div>
    </div>
    ...
    <div class="rounded-2xl border border-white/5 bg-white/[0.03] p-6 space-y-4">
      ...
      <button type="button" @click="addItem()"
        class="inline-flex items-center gap-2 text-sm text-violet-400 hover:text-violet-300 transition-colors">
