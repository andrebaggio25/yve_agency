...
<div>
  <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
    <div>
      <p class="text-xs font-semibold uppercase tracking-widest text-violet-500 mb-1"><?= t('nav.users') ?></p>
  ...
  <div class="flex flex-col items-center justify-center py-24 text-center">
    ...
    <?php if (\App\Support\Auth::can('users.create')): ?>
    <a href="/usuarios/novo" class="mt-4 text-sm text-violet-400 hover:text-violet-300 transition-colors">
      <?= t('users.new') ?> →
    </a>
    <?php endif; ?>
  </div>
      ...
      <tbody class="divide-y divide-white/5">
        ...
        <tr class="hover:bg-white/[0.02] transition-colors">
          ...
          <td class="px-5 py-4 text-right">
            ...
            <a href="/usuarios/<?= e($user['id']) ?>/editar" class="text-xs text-gray-400 hover:text-violet-300 transition-colors">
              <?= t('common.edit') ?>
            </a>
            <?php endif; ?>
          </td>
