  ...
  <div class="grid sm:grid-cols-2 gap-6">
    ...
    <div>
      ...
      <select name="client_id" required
        class="w-full rounded-xl border border-white/10 bg-[#09090f] px-4 py-2.5 text-white focus:border-violet-500 focus:outline-none transition-colors">
    ...
    <div class="flex items-center gap-3 pt-6">
      <input type="checkbox" id="recurring" name="recurring" value="1" <?= $v('recurring') ? 'checked' : '' ?>
        class="h-4 w-4 rounded border-white/20 bg-white/[0.03] text-violet-500 focus:ring-violet-500">
    ...
    <div>
      ...
      <select name="recurrence" class="w-full rounded-xl border border-white/10 bg-[#09090f] px-4 py-2.5 text-white focus:border-violet-500 focus:outline-none transition-colors">
        <option value="">—</option>
    ...
    <div class="sm:col-span-2">
      ...
      <textarea name="description" rows="3"
        class="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-white placeholder-gray-500 focus:border-violet-500 focus:outline-none transition-colors resize-none"><?= e($v('description')) ?></textarea>
    </div>
    ...
    <div class="sm:col-span-2">
      ...
      <textarea name="notes" rows="2"
        class="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-white placeholder-gray-500 focus:border-violet-500 focus:outline-none transition-colors resize-none"><?= e($v('notes')) ?></textarea>
    </div>
  </div>
