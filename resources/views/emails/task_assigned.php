...
<head>
  ...
  <style>
    ...
    .task-card { background: rgba(184,145,76,0.1); border: 1px solid rgba(184,145,76,0.3); border-radius: 10px; padding: 16px 20px; margin: 20px 0; }
    .task-card p { color: #e6d4b0; font-size: 15px; font-weight: 600; margin: 0; }
    .btn { display: inline-block; background: #c6a15b; color: #0d0d14 !important; font-size: 14px; font-weight: 600; padding: 12px 28px; border-radius: 10px; text-decoration: none; margin-top: 4px; }
