...
<head>
  ...
  <style>
    ...
    .btn { display: inline-block; background: #7c3aed; color: #fff !important; font-size: 14px; font-weight: 600; padding: 14px 32px; border-radius: 10px; text-decoration: none; margin: 8px 0 20px; }
...
<div class="wrapper">
  ...
  <div class="card">
    ...
    <p style="font-size:12px;color:#475569">
      ...
      <span style="color:#a78bfa;word-break:break-all"><?= e($reset_url) ?></span>
    </p>
  </div>
  <div class="footer">
