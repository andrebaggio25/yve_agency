...
<head>
  ...
  <style>
    ...
    .total-row td { color: #f1f5f9 !important; font-size: 15px; font-weight: 700; border-bottom: none; border-top: 2px solid rgba(184,145,76,.4); padding-top: 12px; }
    .total-row td:last-child { color: #d4b478 !important; }
